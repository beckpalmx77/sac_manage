                    ...
                    <ul class="treeview-menu">
                        <li class="treeview"><a href="#!"><i class="icon-arrow-right"></i><span> Authentication</span><i class="icon-arrow-down"></i></a>
                            <ul class="treeview-menu">
                                ...
                                <li><a class="waves-effect waves-dark" href="login.html" target="_blank"><i class="icon-arrow-right"></i><span> Login 1</span></a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-header-text">Horizontal Form</h5>
                                <div class="f-right">
